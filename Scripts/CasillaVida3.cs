...
public class CasillaVida3 : MonoBehaviour
{
    //Realizamos la definición del delegado que activará el efecto en el GameObject.
    public delegate void _OnGetVida3(GameObject go);
    public static event _OnGetVida3 OnGetVida3;
    ...
    void Awake()
    {
        Casilla = GameObject.FindGameObjectWithTag("CasillaVida3");
