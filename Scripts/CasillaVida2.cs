...
public class CasillaVida2 : MonoBehaviour
{
    //Realizamos la definición del delegado que activará el efecto en el GameObject.
    public delegate void _OnGetVida2(GameObject go);
    public static event _OnGetVida2 OnGetVida2;
    ...
    void Awake()
    {
        Casilla = GameObject.FindGameObjectWithTag("CasillaVida2");
