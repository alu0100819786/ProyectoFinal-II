...
public class CasillaVida6 : MonoBehaviour
{
    //Realizamos la definición del delegado que activará el efecto en el GameObject.
    public delegate void _OnGetVida6(GameObject go);
    public static event _OnGetVida6 OnGetVida6;
    ...
    void Awake()
    {
        Casilla = GameObject.FindGameObjectWithTag("CasillaVida6");
