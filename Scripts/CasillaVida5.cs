...
public class CasillaVida5 : MonoBehaviour
{
    //Realizamos la definición del delegado que activará el efecto en el GameObject.
    public delegate void _OnGetVida5(GameObject go);
    public static event _OnGetVida5 OnGetVida5;
    ...
    void Awake()
    {
        Casilla = GameObject.FindGameObjectWithTag("CasillaVida5");
